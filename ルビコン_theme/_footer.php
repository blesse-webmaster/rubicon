      ...
      <div class="row mb-lg-2">
        <div class="col-12 col-lg-5 mb-5">
          ...
          <ul class="nav d-flex flex-column mt-3">
            <li class="nav-item mb-1"><a href="/" class="nav-link text-decoration-none p-0 white">不動産業者</a></li>
            <li class="nav-item mb-1"><a href="/" class="nav-link text-decoration-none p-0 white">エリア</a></li>
            <li class="nav-item mb-1"><a href="/" class="nav-link text-decoration-none p-0 white">コラム</a></li>
          </ul>
        </div>
        <div class="col-12 col-lg-7">
          ...
          <ul class="nav row mt-3">
            <li class="nav-item mb-1 col-6 col-sm-4 col-lg-3"><a href="/" class="nav-link text-decoration-none white p-0">2024/06</a></li>
            <li class="nav-item mb-1 col-6 col-sm-4 col-lg-3"><a href="/" class="nav-link text-decoration-none white p-0">2024/05</a></li>
            <li class="nav-item mb-1 col-6 col-sm-4 col-lg-3"><a href="/" class="nav-link text-decoration-none white p-0">2024/04</a></li>
            <li class="nav-item mb-1 col-6 col-sm-4 col-lg-3"><a href="/" class="nav-link text-decoration-none white p-0">2024/03</a></li>
            <li class="nav-item mb-1 col-6 col-sm-4 col-lg-3"><a href="/" class="nav-link text-decoration-none white p-0">2024/02</a></li>
            <li class="nav-item mb-1 col-6 col-sm-4 col-lg-3"><a href="/" class="nav-link text-decoration-none white p-0">2024/01</a></li>
          </ul>
        </div>
  ...
  <div class="pb-3">
    <div class="container">
      <div class="d-flex flex-column flex-lg-row justify-content-lg-between py-4">
        <ul class="nav">
          <li class="nav-item mb-2 me-3"><a href="./" class="nav-link p-0 white">HOME</a></li>
          <li class="nav-item mb-2 me-3"><a href="./privacypolicy" class="nav-link p-0 white">プライバシーポリシー</a></li>
          <li class="nav-item mb-2 me-3"><a href="./profile" class="nav-link p-0 white">運営者情報</a></li>
          <li class="nav-item mb-2 me-3"><a href="./sitemap" class="nav-link p-0 white">サイトマップ</a></li>
        </ul>
        <p class="small white">&copy; Copyright 日野市の不動産売却ガイド All Rights Reserved.</p>
      </div>
    </div>
  </div>
</footer>
