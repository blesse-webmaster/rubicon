        ...
        <section class="col-lg-8 col-12 my-3">
          ...
          <?php if ( has_post_thumbnail() ): //アイキャッチ画像を設定している場合 ?>
            ...
            <?php else: //アイキャッチ画像を設定していない場合 ?>
              <picture>
                <source type="image/webp" srcset="<?php echo get_theme_file_uri(); ?>/asset/img/news-04.webp">
                <img src="<?php echo get_template_directory_uri() ?>/asset/img/news-04.png" alt="<?php the_title(); ?>" class="border img-fluid thumbnail-object-fit">
              </picture>
            <?php endif; ?>
			</a>
            </figure>
            <div class="col-lg-9 col-8">
              <a href="<?php the_permalink() ?>" class="text-decoration-none"><h3 class="f-mincho gray fw-bold fs-5"><?php echo wp_trim_words( get_the_title(), 30, '...' ); ?></h3></a>
          ...
          <div class="container mb-5 mt-5">
            <a href="<?php echo home_url(); ?>">
              <picture>
                <source type="image/webp" srcset="<?php echo get_theme_file_uri(); ?>/asset/img/banner_bottom.webp">
                <img src="<?php echo get_theme_file_uri(); ?>/asset/img/banner_bottom.png" alt="マンション駐輪場の改修・リニューアルガイド" class="img-fluid" loading="lazy"
